 ...
 implements sop_corba.FacturaIntOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         String nombres = in.read_string ();
         String apellidos = in.read_string ();
         String nombreProducto = in.read_string ();
         float valorInicialOferta = in.read_float ();
         float ValorFinalOferta = in.read_float ();
         sop_corba.FacturaIntPackage.facturaDTO $result = null;
         $result = this.generarFactura (nombres, apellidos, nombreProducto, valorInicialOferta, ValorFinalOferta);
         out = $rh.createReply();
         sop_corba.FacturaIntPackage.facturaDTOHelper.write (out, $result);
         break;
       }
