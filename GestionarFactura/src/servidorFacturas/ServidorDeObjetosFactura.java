...
public class ServidorDeObjetosFactura {
    ...
    public static void main(String[] args) {
       try{
        ...
        GenerarFacturaImpl objRemoto = new GenerarFacturaImpl();
    ...
    private static void inicializarORB(String[] vec, GenerarFacturaImpl objRemoto) throws ServantNotActive, WrongPolicy, org.omg.CORBA.ORBPackage.InvalidName, AdapterInactive, InvalidName, NotFound, CannotProceed
  {             
      ...
      FacturaInt href = FacturaIntHelper.narrow(obj);
